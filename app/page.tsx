      ...
      <main className="flex-1">
        ...
        <section className="banner-section w-full relative">
          <div className="w-full min-h-[300px] aspect-[1728/586]">
            <Image src="/images/banner.png" alt="banner" width={1728} height={586} className="w-full h-full object-cover" />
          </div>
          <div
            className="container absolute top-0 left-0 right-0 bottom-0 w-full h-full z-10 flex items-center justify-center">
            <div
              className="flex flex-col sm:w-full w-[90%] max-w-[813px] items-center justify-center lg:gap-7 md:gap-5 gap-2 text-center">
              ...
              <p className="text-sm sm:text-base md:text-lg sm:font-medium font-light text-white lg:max-w-[550px] max-w-[400px] text-center mx-auto">
                Build smarter itineraries in minutes with real-time travel, stay, and experience updates.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="w-full max-w-[850px] mx-auto">
              <div className="w-full py-2.5 relative flex">
                <svg className="sm:min-w-[68px] min-w-[48px] sm:h-[41px] h-[21px] -mt-2.5 -me-[24px]" viewBox="0 0 68 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M68 0C29.5 1.5 30 40.4258 0 40.9258H68V0Z" fill="white" />
                </svg>
                <form
                  ...
                  <div className="flex min-w-0 flex-1 items-center gap-2.5">
                    ...
                    {/*  <label className="sr-only" htmlFor="travel-prompt">Ask me anything about travel</label>  */}
                    <input
                      id="travel-prompt"
                      type="text"
                      name="q"
                  ...
                  <button
                    ...
                    <svg className="sm:w-[24px] w-[18px] sm:h-[24px] h-[18px]" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M9.99995 14L20.9999 3M20.9999 3L2.99995 9.5C2.90421 9.54387 2.82307 9.61431 2.76619 9.70295C2.70931 9.79158 2.67908 9.89468 2.67908 10C2.67908 10.1053 2.70931 10.2084 2.76619 10.2971C2.82307 10.3857 2.90421 10.4561 2.99995 10.5L9.99995 14L13.4999 21C13.5438 21.0957 13.6143 21.1769 13.7029 21.2338C13.7915 21.2906 13.8946 21.3209 13.9999 21.3209C14.1053 21.3209 14.2084 21.2906 14.297 21.2338C14.3856 21.1769 14.4561 21.0957 14.4999 21L20.9999 3Z" stroke="white" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </button>
                </form>
                <div
                ...
                <svg className="sm:min-w-[66px] min-w-[48px] sm:h-[41px] h-[21px] -mt-2.5 -ms-[24px]" viewBox="0 0 68 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0 0C38.5 1.5 38 40.4258 68 40.9258H0V0Z" fill="white" />
                </svg>
              </div>
            </div>
            ...
            <div
              ...
              <div className="inline-flex max-w-full flex-nowrap items-center gap-x-[15px] py-0.5">
                {[
                  ...
                  const clipId = `travel_suggest_clip_${i}`;
                  return (
                    <button
                      key={i}
                      type="button"
            ...
            <div className="md:flex hidden flex-wrap justify-center lg:gap-x-14 gap-x-10 gap-y-3">
              <figure>
                <Image src="./images/discovery.svg" alt="discovery" width={120} height={40} className="w-full h-full object-contain opacity-60" />
              </figure>
              <figure>
                <Image src="./images/papajohns.svg" alt="papajohns" width={120} height={40} className="w-full h-full object-contain opacity-60" />
              </figure>
              <figure>
                <Image src="./images/disnep.svg" alt="disnep" width={120} height={40} className="w-full h-full object-contain opacity-60" />
              </figure>
              <figure>
                <Image src="./images/bbcworld.svg" alt="bbcworld" width={120} height={40} className="w-full h-full object-contain opacity-60" />
              </figure>
              <figure>
                <Image src="./images/google.svg" alt="google" width={120} height={40} className="w-full h-full object-contain opacity-60" />
              </figure>
              <figure>
                <Image src="./images/tata.svg" alt="tata" width={120} height={40} className="w-full h-full object-contain opacity-60" />
              </figure>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 sm:gap-14">
              <div className="order-2 sm:order-1 lg:col-span-8 sm:flex">
                <div className="flex w-full flex-col sm:gap-5 gap-2 lg:max-w-[555px] xl:py-[60px] lg:py-[20px]">
                  <h2
                    className="text-balance text-xl sm:text-2xl md:text-3xl xl:text-4xl font-semibold leading-tight ">
                    Travel Smarter. Explore Better.
                  </h2>
                  <div className="flex flex-col gap-4 text-sm font-normal leading-relaxed text-zinc-600">
                    <p>
                      Welcome to My Travel Geek — your intelligent travel companion built for modern
                      explorers. We believe planning a trip should feel exciting, not overwhelming.
                      That's why we created a platform that simplifies every step of your journey with smart
                      recommendations, real-time travel insights, and personalized experiences.
                    </p>
                    <p>
                      Whether you're planning a quick getaway, a business trip, or a multi-country adventure,
                      My Travel Geek helps you discover the best flights, stays, restaurants, and experiences
                      — all in one place.
                    </p>
                  </div>
                </div>
              ...
              <div className="order-1 sm:order-2 lg:col-span-4">
                <figure className="w-full h-full">
                  <Image src="/images/vecteezy_young.png" alt="young" width={400} height={400} className="lg:w-full w-[70%] mx-auto h-full object-contain " />
                </figure>
              </div>
          ...
          <div className="container relative">
            ...
            <div className="relative z-10 mx-auto flex w-full max-w-[1360px] flex-col items-center gap-10 sm:gap-14">
              <div className="flex w-full max-w-[732px] flex-col items-center gap-[15px] text-center">
                <h2
                  className="text-balance text-xl sm:text-2xl md:text-3xl xl:text-4xl font-semibold">
                  Everything You Need for Smarter Travel
                </h2>
                <p className="text-sm">
                  Plan, compare, and manage every part of your journey with personalized recommendations and
                  real-time travel assistance.
                </p>
              </div>
              <div
                className="grid w-full grid-cols-1 gap-10 self-stretch sm:grid-cols-2 sm:gap-5 lg:grid-cols-4 lg:gap-5">
                <div className="flex flex-col items-center sm:gap-[30px] gap-[14px] text-center">
                  <div
                    className="flex size-[57px] shrink-0 items-center justify-center rounded-[20px] bg-blue-500 text-white">
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12.5 17.5L26.25 3.75M26.25 3.75L3.74997 11.875C3.63029 11.9298 3.52887 12.0179 3.45777 12.1287C3.38667 12.2395 3.34888 12.3684 3.34888 12.5C3.34888 12.6316 3.38667 12.7605 3.45777 12.8713C3.52887 12.9821 3.63029 13.0702 3.74997 13.125L12.5 17.5L16.875 26.25C16.9298 26.3697 17.0179 26.4711 17.1287 26.5422C17.2394 26.6133 17.3683 26.6511 17.5 26.6511C17.6316 26.6511 17.7605 26.6133 17.8713 26.5422C17.9821 26.4711 18.0701 26.3697 18.125 26.25L26.25 3.75Z" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  ...
                  <div className="flex flex-col gap-2.5">
                    ...
                    <p className="text-sm font-normal leading-relaxed text-zinc-600">
                      Discover personalized destinations, unique experiences, and travel ideas tailored to your
                      style.
                    </p>
                  </div>
                </div>
                <div className="flex flex-col items-center sm:gap-[30px] gap-[14px] text-center">
                  <div
                    className="flex size-[57px] shrink-0 items-center justify-center rounded-[20px] bg-orange-500 text-white">
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12.5 17.5L26.25 3.75M26.25 3.75L3.74997 11.875C3.63029 11.9298 3.52887 12.0179 3.45777 12.1287C3.38667 12.2395 3.34888 12.3684 3.34888 12.5C3.34888 12.6316 3.38667 12.7605 3.45777 12.8713C3.52887 12.9821 3.63029 13.0702 3.74997 13.125L12.5 17.5L16.875 26.25C16.9298 26.3697 17.0179 26.4711 17.1287 26.5422C17.2394 26.6133 17.3683 26.6511 17.5 26.6511C17.6316 26.6511 17.7605 26.6133 17.8713 26.5422C17.9821 26.4711 18.0701 26.3697 18.125 26.25L26.25 3.75Z" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                ...
                <div className="flex flex-col items-center sm:gap-[30px] gap-[14px] text-center">
                  <div
                    className="flex size-[57px] shrink-0 items-center justify-center rounded-[20px] bg-emerald-500 text-white">
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12.5 17.5L26.25 3.75M26.25 3.75L3.74997 11.875C3.63029 11.9298 3.52887 12.0179 3.45777 12.1287C3.38667 12.2395 3.34888 12.3684 3.34888 12.5C3.34888 12.6316 3.38667 12.7605 3.45777 12.8713C3.52887 12.9821 3.63029 13.0702 3.74997 13.125L12.5 17.5L16.875 26.25C16.9298 26.3697 17.0179 26.4711 17.1287 26.5422C17.2394 26.6133 17.3683 26.6511 17.5 26.6511C17.6316 26.6511 17.7605 26.6133 17.8713 26.5422C17.9821 26.4711 18.0701 26.3697 18.125 26.25L26.25 3.75Z" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                ...
                <div className="flex flex-col items-center sm:gap-[30px] gap-[14px] text-center">
                  <div
                    className="flex size-[57px] shrink-0 items-center justify-center rounded-[20px] bg-violet-500 text-white">
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12.5 17.5L26.25 3.75M26.25 3.75L3.74997 11.875C3.63029 11.9298 3.52887 12.0179 3.45777 12.1287C3.38667 12.2395 3.34888 12.3684 3.34888 12.5C3.34888 12.6316 3.38667 12.7605 3.45777 12.8713C3.52887 12.9821 3.63029 13.0702 3.74997 13.125L12.5 17.5L16.875 26.25C16.9298 26.3697 17.0179 26.4711 17.1287 26.5422C17.2394 26.6133 17.3683 26.6511 17.5 26.6511C17.6316 26.6511 17.7605 26.6133 17.8713 26.5422C17.9821 26.4711 18.0701 26.3697 18.125 26.25L26.25 3.75Z" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  ...
                  <div className="flex flex-col gap-2.5">
                    ...
                    <p className="text-sm font-normal leading-relaxed text-zinc-600">
                      Stay on track with live navigation, instant updates, local recommendations, and travel
                      tips.
                    </p>
                  </div>
                </div>
        ...
        <section className="relative">
          <div className="container-fluid">
            <div
              className="relative overflow-hidden rounded-[30px] lg:min-h-[650px] flex items-center justify-center bg-black bg-[url('/images/chat-in-any.png')] bg-cover bg-center px-4 py-[clamp(40px,5vw,100px)] lg:px-[clamp(16px,4vw,100px)]">

              <div className="flex items-center justify-center gap-10">
                <div className="hidden lg:block flex-1">
                  <div className="flex flex-col gap-10 items-end" aria-hidden="true">
                    <span
                      className="relative block w-[145px] overflow-hidden rounded-full border border-[#F26537] bg-zinc-900/90 shadow-[0_0_16px_rgba(242,101,55,0.25)] backdrop-blur-sm">
                      <span
                        className="pointer-events-none absolute left-[-11px] top-[10.5px] h-[21px] w-[21px] rounded-full bg-[#F26537] blur-[20.4px]"
                        aria-hidden="true"></span>
                      <span
                        className="relative z-[1] flex items-center justify-center gap-1.5 px-3.5 py-2.5 text-sm font-semibold text-white">
                        <i className="ti ti-sparkles text-base text-white/95"></i>
                        Ciao!
                      </span>
                    </span>
                    <span
                      className="relative me-[70px] block w-[145px] overflow-hidden rounded-full border border-[#F2A437] bg-zinc-900/90 shadow-[0_0_16px_rgba(242,164,55,0.25)] backdrop-blur-sm">
                      <span
                    ...
                    <span
                      className="relative me-[70px] block w-[145px] overflow-hidden rounded-full border border-[#D0F237] bg-zinc-900/90 shadow-[0_0_16px_rgba(208,242,55,0.25)] backdrop-blur-sm">
                      <span
                    ...
                    <span
                      className="relative block w-[145px] overflow-hidden rounded-full border border-[#37F26F] bg-zinc-900/90 shadow-[0_0_16px_rgba(55,242,111,0.25)] backdrop-blur-sm">
                      <span
                ...
                <div className="relative z-10 mx-auto flex flex-col items-center gap-8 text-center max-w-[550px]">
                  <div className="flex flex-col gap-4">
                    <h2
                      className="text-xl sm:text-3xl md:text-4xl xl:text-5xl font-semibold text-white">
                      Chat in any language, anytime, anywhere.
                    </h2>
                    <p
                      className="text-pretty text-sm leading-relaxed text-white sm:text-base md:max-w-xl md:mx-auto">
                      Plan, compare, and manage every part of your journey with personalized recommendations and
                      real-time travel assistance.
                    </p>
                  </div>
                  <button type="button"
                    ...
                    <svg className="h-6 w-6 shrink-0" width="24" height="24" viewBox="0 0 24 24" fill="none"
                      xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                      <path
                        d="M10.6144 17.7956L11.492 15.7854C12.2731 13.9966 13.6789 12.5726 15.4325 11.7942L17.8482 10.7219C18.6162 10.381 18.6162 9.26368 17.8482 8.92277L15.5079 7.88394C13.7092 7.08552 12.2782 5.60881 11.5105 3.75894L10.6215 1.61673C10.2916 0.821766 9.19319 0.821768 8.8633 1.61673L7.97427 3.75892C7.20657 5.60881 5.77553 7.08552 3.97685 7.88394L1.63658 8.92277C0.868537 9.26368 0.868536 10.381 1.63658 10.7219L4.0523 11.7942C5.80589 12.5726 7.21171 13.9966 7.99275 15.7854L8.8704 17.7956C9.20776 18.5682 10.277 18.5682 10.6144 17.7956ZM19.4014 22.6899L19.6482 22.1242C20.0882 21.1156 20.8807 20.3125 21.8695 19.8732L22.6299 19.5353C23.0412 19.3526 23.0412 18.7549 22.6299 18.5722L21.9121 18.2532C20.8978 17.8026 20.0911 16.9698 19.6586 15.9269L19.4052 15.3156C19.2285 14.8896 18.6395 14.8896 18.4628 15.3156L18.2094 15.9269C17.777 16.9698 16.9703 17.8026 15.956 18.2532L15.2381 18.5722C14.8269 18.7549 14.8269 19.3526 15.2381 19.5353L15.9985 19.8732C16.9874 20.3125 17.7798 21.1156 18.2198 22.1242L18.4667 22.6899C18.6473 23.104 19.2207 23.104 19.4014 22.6899Z"
                        fill="url(#paint0_hero_say_hi)" />
                      <defs>
                        <linearGradient id="paint0_hero_say_hi" x1="11.9995" y1="1.02051" x2="11.9995"
                          y2="23.0005" gradientUnits="userSpaceOnUse">
                          <stop stopColor="#F26537" />
                          <stop offset="1" stopColor="#0F3A5D" />
                        </linearGradient>
                      </defs>
                ...
                <div className="hidden lg:block flex-1">
                  <div className="flex flex-col gap-10" aria-hidden="true">
                    <span
                      className="relative block w-[145px] overflow-hidden rounded-full border border-[#37D0F2] bg-zinc-900/90 shadow-[0_0_16px_rgba(55,208,242,0.25)] backdrop-blur-sm">
                      <span
                    ...
                    <span
                      className="relative ms-[70px] block w-[145px] overflow-hidden rounded-full border border-[#3763F2] bg-zinc-900/90 shadow-[0_0_16px_rgba(55,99,242,0.25)] backdrop-blur-sm">
                      <span
                    ...
                    <span
                      className="relative ms-[70px] block w-[145px] overflow-hidden rounded-full border border-[#A737F2] bg-zinc-900/90 shadow-[0_0_16px_rgba(167,55,242,0.25)] backdrop-blur-sm">
                      <span
                    ...
                    <span
                      className="relative block w-[145px] overflow-hidden rounded-full border border-[#F2374A] bg-zinc-900/90 shadow-[0_0_16px_rgba(242,55,74,0.25)] backdrop-blur-sm">
                      <span
          ...
          <div className="container">
            ...
            <div className="relative z-10 mx-auto flex w-full max-w-[1360px] flex-col items-center gap-[30px] sm:gap-10 md:gap-14">
              <div className="flex w-full max-w-[732px] flex-col items-center gap-[15px] text-center">
                ...
                <p className="text-sm">
                  Plan, compare, and manage every part of your journey with personalized recommendations and real-time travel assistance.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    layout: 'lead',
                    prompt: 'Gourmet seafood by the sea and coastal restaurants with great views',
                  },
                  {
                  ...
                  {
                    Image: 'https://images.unsplash.com/photo-1507608869274-d3177c8bb4c7?w=800&q=80&auto=format&fit=crop',
                  ...
                  const bodyWrap = card.layout === 'quote';
                  const bodyClass = isLead
                    ? 'flex flex-1 flex-col gap-[25px] p-5'
                    : 'flex flex-1 flex-col justify-between gap-6 p-5';
                  const footerClass = isLead ? 'mt-auto flex flex-col gap-2.5' : 'flex flex-col gap-2.5';
                      ...
                      <div className={bodyClass}>
                        ...
                        <div className={footerClass}>
                          <button type="button"
                            ...
                            data-q={card.prompt}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M10.6144 17.7956L11.492 15.7854C12.2731 13.9966 13.6789 12.5726 15.4325 11.7942L17.8482 10.7219C18.6162 10.381 18.6162 9.26368 17.8482 8.92277L15.5079 7.88394C13.7092 7.08552 12.2782 5.60881 11.5105 3.75894L10.6215 1.61673C10.2916 0.821766 9.19319 0.821768 8.8633 1.61673L7.97427 3.75892C7.20657 5.60881 5.77553 7.08552 3.97685 7.88394L1.63658 8.92277C0.868537 9.26368 0.868536 10.381 1.63658 10.7219L4.0523 11.7942C5.80589 12.5726 7.21171 13.9966 7.99275 15.7854L8.8704 17.7956C9.20776 18.5682 10.277 18.5682 10.6144 17.7956ZM19.4014 22.6899L19.6482 22.1242C20.0882 21.1156 20.8807 20.3125 21.8695 19.8732L22.6299 19.5353C23.0412 19.3526 23.0412 18.7549 22.6299 18.5722L21.9121 18.2532C20.8978 17.8026 20.0911 16.9698 19.6586 15.9269L19.4052 15.3156C19.2285 14.8896 18.6395 14.8896 18.4628 15.3156L18.2094 15.9269C17.777 16.9698 16.9703 17.8026 15.956 18.2532L15.2381 18.5722C14.8269 18.7549 14.8269 19.3526 15.2381 19.5353L15.9985 19.8732C16.9874 20.3125 17.7798 21.1156 18.2198 22.1242L18.4667 22.6899C18.6473 23.104 19.2207 23.104 19.4014 22.6899Z" fill="url(#paint0_linear_111_6822)" />
                              <defs>
                                <linearGradient id="paint0_linear_111_6822" x1="11.9995" y1="1.02051" x2="11.9995" y2="23.0005" gradientUnits="userSpaceOnUse">
                                  <stop stopColor="#F26537" />
                                  <stop offset="1" stopColor="#0F3A5D" />
                                </linearGradient>
                              </defs>
          ...
          <div className="container">
            <div className="rounded-[15px] px-4 py-[clamp(40px,5vw,130px)] bg-[url('/images/my-travel.png')] bg-cover bg-center">
              <div className="max-w-[600px] mx-auto">
                <div className="flex w-full max-w-[732px] flex-col items-center gap-[15px] text-center">
                  <h2
                    className="text-balance text-xl sm:text-2xl md:text-3xl xl:text-4xl font-semibold text-white">
                    MyTravelGeek for Brands
                  </h2>
                  <p className="text-sm text-white">
                    We are the AI backbone of the travel industry. Build and launch your own customized AI agents based on your brand, content, data and partnerships.
                  </p>
