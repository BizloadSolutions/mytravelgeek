...
export default function Footer() {
  return (
    <footer
      ...
      role="contentinfo"
    >
      <div className="container flex w-full max-w-full flex-col items-stretch md:items-end gap-[clamp(30px,4vw,80px)]">
        ...
        <div className="flex w-full flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <p
            ...
            className="text-center text-sm font-normal text-zinc-600 sm:text-left order-2 sm:order-1"
          >
            Copyright © {new Date().getFullYear()} MyTravelGeek. All Rights
            Reserved
          </p>
          <div className="flex flex-wrap items-center justify-center gap-5 sm:justify-end order-1 sm:order-2">
            <a
              href="/privacy-policy"
              className="text-center text-sm font-normal text-zinc-600 underline decoration-zinc-600 underline-offset-2 transition-colors hover:text-zinc-900"
            >
              Privacy Policy
            </a>
            <a
